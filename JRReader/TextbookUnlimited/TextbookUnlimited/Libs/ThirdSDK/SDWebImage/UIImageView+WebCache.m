...
- (void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock {
    ...
    NSString*newStrUrl = [strUrl stringByRemovingPercentEncoding];
    newStrUrl = [newStrUrl stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
    NSURL* newUrl = [NSURL URLWithString:newStrUrl];
    url = newUrl;
    //zwqend
